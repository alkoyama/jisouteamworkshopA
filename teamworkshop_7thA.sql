...
CREATE TABLE `customer_management` (
  ...
  `Card_info` varchar(20) DEFAULT NULL,
...
INSERT INTO `customer_management` VALUES ('C001','レッド','カントー マサラタウン 1-1-2','09012345678','1111222233334444','abc123'),('C002','グリーン','カントー マサラタウン 1-1-1','09087654321','4444333322221111','abc123'),('C003','ゴールド','ジョウト ワカバタウン 1-2-1','08012345678','2222444466668888','abc123'),('C004','シルバー','ジョウト ワカバタウン 1-2-2','08087654321','8888666644442222','abc123');
...
INSERT INTO `order_detail` VALUES ('OD001','O001','S005',1,500),('OD002','O001','S006',1,600),('OD003','O001','S007',1,700),('OD004','O001','S008',2,1600),('OD005','O002','S111',1,20000),('OD006','O002','S112',1,8000),('OD007','O002','S094',7,1400),('OD008','O002','S095',4,2400),('OD009','O002','S096',9,7200),('OD010','O003','S041',2,8200),('OD011','O003','S062',2,12400),('OD012','O003','S103',5,5000),('OD013','O003','S102',4,4000),('OD014','O004','S030',3,9000),('OD015','O004','S031',3,9300),('OD016','O004','S032',2,6400),('OD017','O004','S042',1,4200),('OD018','O005','S097',3,900),('OD019','O005','S098',3,3000),('OD020','O005','S099',3,3000),('OD021','O006','S009',3,2700),('OD022','O006','S091',2,182000),('OD023','O006','S092',4,36800);
...
CREATE TABLE `order_management` (
  ...
  `Grand_total_price` int(20) NOT NULL,
  PRIMARY KEY (`OID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_management` VALUES ('O001','2024-05-12 16:19:38','C001','レッド','カントー マサラタウン 1-1-2','09012345678','1111222233334444',3400),('O002','2024-05-12 16:20:36','C002','グリーン','カントー マサラタウン 1-1-1','09087654321','4444333322221111',39000),('O003','2024-05-12 16:22:22','C003','ゴールド','ジョウト ワカバタウン 1-2-1','08012345678','2222444466668888',29600),('O004','2024-05-12 16:23:35','C004','シルバー','ジョウト ワカバタウン 1-2-2','08087654321','8888666644442222',28900),('O005','2024-05-12 16:28:10','GUEST','オーキド','カントー マサラタウン 2-1-1','09011115555','1234567887654321',6900),('O006','2024-05-12 16:29:55','GUEST','ウツギ','ジョウト ワカバタウン 2-1-3','09099990000','9999888877776666',221500);
...
INSERT INTO `product_stock` VALUES ('S001','P001','male',100,2),('S002','P002','male',200,0),('S003','P003','unknown',30000,2),('S004','P004','male',400,71),('S005','P005','male',500,17),('S006','P006','male',600,52),('S007','P007','male',700,36),('S008','P008','male',800,64),('S009','P009','male',900,30),('S010','P010','male',1000,0),('S011','P011','male',1100,25),('S012','P012','male',1200,52),('S013','P013','male',1300,7),('S014','P014','male',1400,0),('S015','P015','male',1500,20),('S016','P016','male',1600,16),('S017','P017','male',1700,17),('S018','P018','male',1800,18),('S019','P019','male',1900,19),('S020','P020','male',2000,20),('S021','P021','male',2100,21),('S022','P022','male',2200,22),('S023','P023','male',2300,22),('S024','P024','female',2400,19),('S025','P025','male',2500,25),('S026','P026','male',2600,26),('S027','P027','male',2700,27),('S028','P028','male',2800,28),('S029','P029','male',2900,29),('S030','P030','male',3000,26),('S031','P031','male',3100,28),('S032','P032','male',3200,30),('S033','P033','male',3300,33),('S034','P034','male',3400,34),('S035','P035','male',3500,35),('S036','P036','male',3600,36),('S037','P037','male',3700,37),('S038','P038','male',3800,38),('S039','P039','male',3900,39),('S040','P040','male',4000,38),('S041','P041','unknown',4100,39),('S042','P042','male',4200,41),('S043','P043','male',4300,43),('S044','P044','male',4400,44),('S045','P045','male',4500,41),('S046','P046','male',4600,46),('S047','P047','male',4700,44),('S048','P048','male',4800,48),('S049','P049','male',4900,49),('S050','P050','male',5000,50),('S051','P051','male',5100,51),('S052','P052','male',5200,52),('S053','P053','male',5300,53),('S054','P054','unknown',5400,53),('S055','P055','female',5500,50),('S056','P056','male',5600,56),('S057','P057','male',5700,57),('S058','P058','unknown',5800,58),('S059','P059','male',5900,59),('S060','P060','female',6000,60),('S061','P061','unknown',6100,61),('S062','P062','male',6200,56),('S063','P063','female',6300,63),('S064','P064','male',6400,64),('S065','P065','male',6500,65),('S066','P066','male',6600,66),('S067','P067','male',6700,67),('S068','P068','male',6800,68),('S069','P069','male',6900,69),('S070','P070','male',7000,70),('S071','P071','male',7100,71),('S072','P072','unknown',90000,5),('S073','P073','male',7300,73),('S074','P074','unknown',7400,74),('S075','P075','male',7500,75),('S076','P076','male',7600,76),('S077','P077','male',7700,77),('S078','P078','unknown',78000,7),('S079','P079','female',7900,79),('S080','P080','male',8000,80),('S081','P081','male',8100,81),('S082','P082','unknown',820000,82),('S083','P083','male',8300,83),('S084','P084','male',8400,84),('S085','P085','male',8500,85),('S086','P086','male',8600,86),('S087','P087','male',8700,87),('S088','P088','male',8800,88),('S089','P089','male',8900,89),('S090','P090','male',9000,90),('S091','P091','unknown',91000,89),('S092','P092','male',9200,88),('S093','P093','male',9300,93),('S094','P094','ball',200,93),('S095','P095','ball',600,96),('S096','P096','ball',800,91),('S097','P097','ball',300,97),('S098','P098','ball',1000,47),('S099','P099','ball',1000,47),('S100','P100','ball',1000,50),('S101','P101','ball',3000,10),('S102','P102','ball',1000,46),('S103','P103','ball',1000,45),('S104','P104','ball',1000,50),('S105','P105','ball',1000,50),('S106','P106','egg',200,10),('S107','P107','egg',500,10),('S108','P108','egg',700,10),('S109','P109','egg',1000,10),('S110','P110','egg',1200,10),('S111','P111','item',20000,9),('S112','P112','item',8000,9),('S113','P113','item',5000,10),('S114','P114','item',20000,10),('S115','P115','item',30000,5);
...
-- Dump completed on 2024-05-13 10:56:08
